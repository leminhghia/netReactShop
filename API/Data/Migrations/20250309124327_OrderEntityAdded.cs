        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddres_Name = table.Column<string>(type: "TEXT", nullable: false),
                    ShippingAddres_Line1 = table.Column<string>(type: "TEXT", nullable: false),
                    ShippingAddres_Line2 = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingAddres_City = table.Column<string>(type: "TEXT", nullable: false),
                    ShippingAddres_State = table.Column<string>(type: "TEXT", nullable: false),
                    ShippingAddres_PostalCode = table.Column<string>(type: "TEXT", nullable: false),
