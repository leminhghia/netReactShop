...
import { IAddress, IUser } from "../../app/models/user";
...
export const accountApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        fetchAddress: builder.query<IAddress, void>({
            query: () => ({
                url: 'account/address'
            })
        }),
        updateUserAddress: builder.mutation<IAddress, IAddress>({
            query: (address) => ({
                url: 'account/address',
                method: 'POST',
                body: address
...
export const { useLoginMutation, useLogoutMutation,
     useRegisterMutation, useUserInfoQuery, useLazyUserInfoQuery,
